 ...
 * $Id: pcblog.h 12274 2021-08-30 12:20:04Z Fabrice $
 *
...
/**
 * @fn void pcblog_write_can_msg(TPCANHandle channel, int direction, TPCANMsg* pmsg)
...
/**
 * @fn void pcblog_write_canfd_msg(TPCANHandle channel, int direction, TPCANMsgFD* pmsg)
 * @brief Formats and logs a CAN message from a PCANBasic channel.
 *
 * @param[in] channel a PCANBasic channel handle
 * @param[in] direction of the message: Rx (LOG_FUNCTION_READ) or Tx (LOG_FUNCTION_WRITE)
 ...
 */
void pcblog_write_canfd_msg(TPCANHandle channel, int direction, TPCANMsgFD* pmsg);
